        ...
        <div className="w-screen max-w-md bg-white shadow-2xl border-l border-clinical-border flex flex-col">
          ...
          <div className="border-t border-clinical-border bg-slate-50 p-4 space-y-2">
            <button
              ...
              className="w-full inline-flex items-center justify-center gap-2 rounded-lg bg-clinical-primary-container text-white py-2.5 px-4 text-xs font-bold hover:bg-clinical-primary transition shadow-sm"
            >
              <Sparkles className="h-4 w-4" />
              Run / View AI Assessment
            </button>
            <div className="grid grid-cols-2 gap-2">
              <button
                onClick={() => {
                  onClose();
                  navigate('/beds', { state: { selectedPatient: patient } });
                }}
                className="inline-flex items-center justify-center gap-1.5 rounded-lg border border-slate-300 bg-white text-slate-700 py-2 px-3 text-xs font-semibold hover:bg-slate-50 transition"
              >
              ...
              <button
                onClick={() => {
                  onClose();
                  navigate('/doctors', { state: { targetPatient: patient } });
                }}
                className="inline-flex items-center justify-center gap-1.5 rounded-lg border border-slate-300 bg-white text-slate-700 py-2 px-3 text-xs font-semibold hover:bg-slate-50 transition"
              >
