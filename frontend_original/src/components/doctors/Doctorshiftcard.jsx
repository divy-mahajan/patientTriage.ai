      ...
      <div className="mt-3 pt-3 border-t border-slate-100 flex items-center justify-between">
        ...
        {onQuickAssign && isAvailable && doctor.current_caseload < doctor.max_caseload && (
          <button
            ...
            className="inline-flex items-center gap-1 rounded bg-blue-50 px-2 py-1 text-xs font-bold text-clinical-primary-container hover:bg-blue-100 transition cursor-pointer"
          >
