...
export const DoctorsCheckInModal = ({ isOpen, onClose, onCheckInSuccess, initialDoctor = null }) => {
      ...
      footer={
        <>
          ...
          <button
            ...
            disabled={loading}
            className="rounded-lg bg-clinical-primary-container px-4 py-2 text-xs font-bold text-white hover:bg-clinical-primary transition shadow-xs disabled:opacity-50 cursor-pointer"
          >
...
export default DoctorsCheckInModal;
